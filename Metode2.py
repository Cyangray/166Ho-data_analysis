...
import matplotlib
from systlib import gauss_arglist, GLO_arglist, GLO_hybrid_arglist, upbend_draw_arglist, PDR_to_MeVbarn, SLO_arglist, load_known_gsf, gsf
...
#M1 strengths
Ho166_M1 = load_known_gsf(A,'Ho', nature = 'M1')
...
#Which plot. 'berman', 'bergere' or 'varlamov'
plot_switch = '0.66'

#Pick_function to model the second gdr
...
for i, T in enumerate(Ts):
    ...
    output = np.array([[166, fit.values[7], fit.errors[7], fit.values[8], fit.errors[8], fit.values[9], fit.errors[9], BSR2040_0[0], (BSR2040_0[1] + BSR2040_0[2])/2,  BSR0010_0[0], (BSR0010_0[1] + BSR0010_0[2])/2, 0.3424]])
